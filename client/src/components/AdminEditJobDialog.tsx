...
interface AdminEditJobDialogProps {
  job: Job;
}

export function AdminEditJobDialog({ job }: AdminEditJobDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit((data) => updateJobMutation.mutate(data))} className="space-y-4">
            <FormField
